...
<input name="activity_type" placeholder="مثال: مطعم وجبات سريعة" className={INPUT_CLASS} />
</Field>
...
<input name="area_sqm" type="number" step="0.01" className={INPUT_CLASS} />
</Field>
<Field label="الإيجار الشهري (ر.س)">
<input name="monthly_rent" type="number" step="0.01" className={INPUT_CLASS} />
</Field>
<Field label="السعر المطلوب (ر.س)">
<input name="asking_price" type="number" step="0.01" className={INPUT_CLASS} />
</Field>
<Field label="متوسط المبيعات الشهرية (ر.س)">
<input name="monthly_sales" type="number" step="0.01" className={INPUT_CLASS} />
</Field>
</div>
...
<div className="bg-white rounded-2xl border border-black/5 p-6 space-y-4">
<h2 className="font-bold text-[#151515]">بيانات صاحب الفرصة (اختياري)</h2>
...
<input name="submitted_by_email" type="email" className={INPUT_CLASS} />
</Field>
</div>
</div>
...
return (
<div>
<label className="block text-sm font-medium text-[#151515] mb-1">{label}</label>
{children}
</div>
);
}
