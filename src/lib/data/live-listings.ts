...
/**
 * يبحث عن فرصة حقيقية بالـ id (slug في روابط سوق الفرص = id السجل في قاعدة البيانات).
 * لا يوجد أي رجوع لبيانات تجريبية هنا عمدًا — أي فرصة تظهر للزائر لازم تكون فرصة حقيقية
 * منشورة فعليًا، حتى لا يصل أحد لصفحة فرصة وهمية عبر رابط قديم أو مباشر.
 */
export async function resolveListing(
    slugOrId: string,
  ): Promise<{ listing: Listing; source: "live" } | null> {
