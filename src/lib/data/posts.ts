  ...
  },
{
    ...
    content: {
      ar: `أكثر خطأ يقع فيه المستثمر الجديد في قطاع المطاعم هو شراء "قصة" بدلًا من شراء مشروع. قد يتحدث صاحب المطعم عن أيام الازدحام، وعن المطبخ الذي أنفق عليه كثيرًا، وعن قاعدة عملاء راضية، ثم يتخذ المستثمر قراره بناءً على الانطباع بدلًا من الأرقام.

## ابدأ من المبيعات، وليس من السعر

لا تبدأ بسؤال "كم السعر؟"؛ ابدأ بسؤال: "كيف أتحقق من المبيعات الحقيقية؟". اطلب كشوف نقاط البيع (POS) لعدة أشهر، وليس لشهر واحد فقط، وراجع فواتير تطبيقات التوصيل إن وجدت. إذا رفض المالك عرض هذه البيانات أو اكتفى بطلب الثقة، فهذه إشارة يجب التوقف عندها.

## فرّق بين قيمة الأصول وقيمة المشروع

للمعدات والديكور قيمة، لكنها لا تساوي قيمة المشروع بالكامل. المشروع الذي يحقق أرباحًا مستقرة ولديه عقد إيجار جيد وقاعدة عملاء حقيقية يستحق سعرًا أعلى من المعدات نفسها داخل محل متوقف. اسأل نفسك: هل أدفع مقابل المعدات أم مقابل قدرة المشروع على توليد الدخل؟

## متوسط الفاتورة وعدد الفواتير

معادلة بسيطة ومهمة: متوسط الفاتورة = إجمالي المبيعات ÷ عدد الفواتير. إذا عرض المالك رقم مبيعات كبيرًا دون إثبات عدد الفواتير أو متوسط الفاتورة، فهناك جزء ناقص في الصورة.

## متجاهلش الإيجار والالتزامات

عقد الإيجار ليس تفصيلًا صغيرًا. تحقق من المدة المتبقية والزيادة السنوية، ومن وجود التزامات أو ديون قد تنتقل إليك، مثل فواتير الكهرباء أو مستحقات الموردين والعمال. قد تبدو الفرصة منخفضة السعر لكنها تصبح مكلفة جدًا عند وجود التزامات مخفية.

## السؤال الأهم: لماذا يبيع؟

يكشف سبب البيع أو التقبيل معلومات مهمة. قد يكون السبب طبيعيًا، مثل انشغال المالك بمشروعات أخرى أو رغبته في تسييل الاستثمار، وقد يكون إشارة تحذير مثل تراجع المبيعات أو مشكلات الإيجار أو ظهور منافسة قوية.

## القرار لا يقتصر على نعم أو لا

بعد جمع هذه الأرقام، لا يلزم أن يكون القرار شراءً أو رفضًا مباشرًا. قد يكون القرار الأنسب هو الشراء بعد التفاوض على السعر أو الشروط، أو طلب بيانات إضافية قبل أي التزام. الهدف هو اتخاذ قرار مبني على أرقام حقيقية، وليس على حماس لحظة المعاينة.`,
...
Once you've gathered this data, you don't necessarily have to decide to buy or walk away immediately. The right call might be "buy after negotiation" on price or terms, or "needs more data" before any commitment. The goal is a decision grounded in real numbers, not the enthusiasm of a single site visit.`,
  ...
  },
  {
    ...
    title: {
      ar: "تكلفة الطعام: لماذا ترتفع دون أن تلاحظ، وكيف تضبطها؟",
      en: "Food Cost: Why It Creeps Up Without You Noticing",
    },
    excerpt: {
      ar: "قد تبقى المبيعات ثابتة بينما تتراجع الأرباح؛ وغالبًا ترتفع تكلفة الطعام من مصادر لا تتم متابعتها يوميًا.",
    ...
    content: {
      ar: `قد يقول صاحب المطعم: "مبيعاتي ثابتة منذ ثلاثة أشهر، لكن الأرباح تتراجع". المشكلة غالبًا ليست في المبيعات، بل في تكلفة الطعام (Food Cost) التي ترتفع دون متابعة دقيقة.

## المعادلة الأساسية

Food Cost % = تكلفة المواد المستخدمة ÷ مبيعات الطعام × 100. المشكلة أن كثيرًا من أصحاب المطاعم يحسبونها من قيمة المشتريات الشهرية فقط، دون مراعاة الفرق في المخزون. الطريقة الأدق:

COGS = مخزون أول المدة + المشتريات − مخزون آخر المدة

من دون جرد دوري، لن يكون الرقم الظاهر أمامك دقيقًا.
...
- سوء التخزين: مواد تتلف قبل استخدامها بسبب تخزين غير صحيح أو عدم تطبيق أولوية الصرف (FIFO).
- ضعف الجرد: من دون جرد أسبوعي أو شهري منتظم، يصعب تحديد موضع المشكلة بدقة.
...
## الحل ليس مجرد تقليل الكمية

يبدأ كثير من أصحاب المطاعم بتقليل حجم الحصة، وهذا يضر تجربة العميل دون معالجة المشكلة الحقيقية. الحل الصحيح يبدأ بجرد دقيق يحدد موضع التسرب قبل اتخاذ أي قرار يخص قائمة الطعام أو الأسعار.

## اربطها بالـPrime Cost

تكلفة الطعام وحدها لا تعرض الصورة كاملة؛ يجب تحليلها مع تكلفة العمالة:

Prime Cost = Food Cost + Labor Cost

تمنحك هذه النسبة صورة أوضح عن صحة التشغيل ككل، وليس تكلفة الطعام فقط. قد تكون تكلفة الطعام منضبطة بينما تكون تكلفة العمالة مرتفعة جدًا، فتستهلك جزءًا كبيرًا من الربح.

## ابدأ بالقياس قبل التغيير

قبل تغيير المشتريات أو قائمة الطعام أو الأسعار، نفّذ جردًا دقيقًا واحسب تكلفة الطعام الفعلية بمعادلة COGS. من دون هذا الرقم، سيكون أي قرار مجرد تخمين.`,
